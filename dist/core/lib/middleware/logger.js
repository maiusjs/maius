...
class LoggerMiddleware extends base_1.BaseMiddleware {
    constructor(maius) {
        super(maius);
    ...
    getMiddlewareOpts(opts) {
        ...
        cfg.name = 'maius:logger';
        cfg._couldReorder = true;
        cfg.load = app => app.use(getKoaLogger(logger_1.default.getInstance().getlogger('http'), { level: 'auto' }));
